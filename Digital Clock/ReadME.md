...
The program should display the drawings of each digit rather than displaying the digits directly.

### Hint:
You can use the Seven-Segment Display Module to generate drawing of each digit.
