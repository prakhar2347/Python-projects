...
# Build a Expense Tracker application with python
## Objective :
Create a basic python Expense Tracker application. In this python project, you will build a simple expense tracker that can keep track of the user’s expenses.
<br>
