...
# Build a Plagarisim Checker application with python
## Objective :
Create a basic python Plagarisim Checker application. The market lacks a free tool that can be used to check for plagiarism in documents. You can use a natural language processing library along with the Google search API to create a program that searches the first few pages of Google and checks for plagiarism
<br>
