...
# Build a Random Password Generator application with python
## Objective :
...
- Add some questions like your favourite food, color, player etc and use them to generate password.
