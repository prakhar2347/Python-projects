...
## Objective :
Build a python project which takes users input of the number of dice he/she wants to roll and then runs dice rolling simulation.<br>
The app will be able to roll up to six dice, with each die having six faces. After every roll, the application will generate an ASCII diagram of dice faces and display it on the screen.
