...
# Build a Leap Year Gusser application with python
## Objective :
Create a basic python Leap Year Gusser application which tells the user to guess it the given year is a leap year or not.
Also add another page or route where the user can enter the year and computer tells if the year is Leap Year or not.
<br>
